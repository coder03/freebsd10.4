...
# $FreeBSD: release/10.4.0/sys/boot/efi/boot1/generate-fat.sh 303297 2016-07-25 14:36:55Z emaste $
...
echo '# $FreeBSD: release/10.4.0/sys/boot/efi/boot1/generate-fat.sh 303297 2016-07-25 14:36:55Z emaste $' >> Makefile.fat
...
echo '$FreeBSD: release/10.4.0/sys/boot/efi/boot1/generate-fat.sh 303297 2016-07-25 14:36:55Z emaste $' >> $OUTPUT_FILE.bz2.uu
